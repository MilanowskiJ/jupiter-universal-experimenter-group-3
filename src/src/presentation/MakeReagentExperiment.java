...
public class MakeReagentExperiment implements UIProcess {
    ...
    public void execute(BufferedReader reader, Queue<BusinessProcessContainer> queue) throws IOException {
        ...
        while(true) {
            ...
            System.out.print("Please Enter business.Experiment Specification: Reagent to apply\n>");
            reagent = reader.readLine();

            System.out.print("Please Enter business.Experiment Specification: Quantity of reagent to apply\n>");
            reagentQuantity = reader.readLine();

            System.out.print("Please Enter business.Experiment Specification: business.Sample to apply reagent to\n>");
            sampleToApplyTo = reader.readLine();

            System.out.print("Please Enter business.Experiment Specification: measurementsToTake (seperate multiple measurements using a comma)\n>");
            ...
            System.out.println("business.Experiment Specification Entered:\n ExperimentID: " + experimentID +
                    ...
                    "\nbusiness.Sample to apply reagent to: " + sampleToApplyTo +
