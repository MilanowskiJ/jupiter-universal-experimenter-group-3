...
public class MakeComplexExperiment implements UIProcess {
    ...
    public void execute(BufferedReader reader, Queue<BusinessProcessContainer> queue) throws IOException {
        ...
        while(true) {
            ...
            System.out.print("Please Enter business.Experiment Specification: What to do (verb)\n>");
            whatToDo = reader.readLine();

            System.out.print("Please Enter business.Experiment Specification: Quantity\n>");
            quantity = reader.readLine();

            System.out.print("Please Enter business.Experiment Specification: business.Supply Item \n>");
            supplyItem = reader.readLine();

            System.out.print("Please Enter business.Experiment Specification: Target \n>");
            target = reader.readLine();

            System.out.println("business.Experiment Specification Entered:\nWhat to do: " + whatToDo + "\nQuantity: " + quantity + "\nbusiness.Supply item: " + supplyItem + "\nTarget: " + target);
